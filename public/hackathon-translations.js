...
const hackathonTranslations = {
    ru: {
        ...
        // Modal form
        modal_title: "Регистрация команды",
        modal_subtitle: "AI Хакатон Самарканд • 6-8 августа 2025",
        modal_conditions: "📝 Важная информация",
        modal_team_size: "• Размер команды: от 3 до 5 человек",
        modal_age: "• Возраст участников: от 16 лет",
        modal_selection: "• Отбор команд: с 1 по 5 августа",
        
        // Form fields
        team_name: "Название команды *",
        team_name_placeholder: "Введите название вашей команды",
        team_leader_name: "ФИО лидера команды *",
        team_leader_name_placeholder: "Фамилия Имя Отчество",
        team_leader_telegram: "Telegram лидера *",
        team_leader_telegram_placeholder: "@username",
        team_leader_phone: "Номер телефона лидера *",
        team_leader_phone_placeholder: "+998 90 123 45 67",
        team_size: "Количество участников в команде *",
        team_size_placeholder: "Выберите количество",
        team_size_3: "3 человека",
        team_size_4: "4 человека", 
        team_size_5: "5 человек",
        project_description: "Описание идеи проекта (не более 2000 символов) *",
        project_description_placeholder: "Опишите вашу идею, какую проблему решает, какие технологии планируете использовать...",
        existing_project: "У нас есть существующий проект, и мы планируем создать для него новый AI-модуль на хакатоне",
        accommodation: "Нужно ли размещение в общежитии School 21?",
        accommodation_no: "Нет, не нужно",
        accommodation_yes: "Да, нужно размещение",
        equipment: "Планируете использовать:",
        equipment_own: "Собственные ноутбуки",
        equipment_school: "Компьютеры School 21 (Linux)",
        equipment_combined: "Комбинированно",
        form_note: "* Обязательные поля. После отправки заявки мы свяжемся с вами для подтверждения участия.",
        form_submit: "Отправить заявку",
        form_cancel: "Отмена",
        ...
        telegram_join: "Присоединяйтесь к нашему Telegram каналу:",
        telegram_channel: "Канал участников хакатона",
    ...
    uz: {
        ...
        modal_subtitle: "AI Xakaton Samarqand • 6-8 avgust 2025",
        modal_conditions: "📝 Muhim ma'lumot",
        modal_team_size: "• Jamoa hajmi: 3 dan 5 kishigacha",
        modal_age: "• Ishtirokchilar yoshi: 16 yoshdan",
        modal_selection: "• Jamoalar tanlovi: 1 avgustdan 5 avgustgacha",
    ...
    en: {
        ...
        modal_subtitle: "AI Hackathon Samarkand • August 6-8, 2025",
        modal_conditions: "📝 Important Information",
        modal_team_size: "• Team size: 3 to 5 people",
        modal_age: "• Participant age: from 16 years",
        modal_selection: "• Team selection: August 1-5",
