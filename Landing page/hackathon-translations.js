...
const hackathonTranslations = {
    ru: {
        title: "AI ХАКАТОН САМАРКАНД",
        subtitle: "3-дневный интенсивный хакатон с международным участием для разработчиков, дизайнеров и предпринимателей",
        date: "6-8 августа 2025",
        location: "Самарканд, Узбекистан",
        prize: "Ценные призы от партнеров",
        participants: "100 участников (команды 3-5 человек)",
        mentors: "20+ менторов",
        register_btn: "ПОДАТЬ ЗАЯВКУ",
        ...
        // Stats section
        stats_days: "Дня интенсива",
        stats_participants: "Участников",
        stats_mentors: "Менторская помощь",
        
        // Program section
        program_title: "Программа хакатона",
        program_subtitle: "Три дня насыщенной программы с лекциями, воркшопами и интенсивной разработкой",
        day1_title: "День 1 - Старт (School 21)",
        day2_title: "День 2 - Разработка (School 21)",
        day3_title: "День 3 - Финал",
        
        // Day 1 schedule
        day1_10: "Регистрация участников",
        day1_11: "Открытие, приветствие партнеров",
        day1_12: "Питчи команд (1 минута на идею)",
        day1_13: "Обед",
        day1_14: "Начало разработки",
        day1_18: "Ужин и продолжение работы",
        
        // Day 2 schedule
        day2_09: "Завтрак",
        day2_10: "Воркшопы по инструментам",
        day2_11: "Менторские сессии",
        day2_13: "Обед",
        day2_14: "Интенсивная разработка",
        day2_16: "Менторские консультации",
        day2_18: "Ужин и продолжение работы",
        
        // Day 3 schedule
        day3_09: "Завтрак",
        day3_10: "Доработка в School 21",
        day3_12: "Подготовка презентаций",
        day3_13: "Обед",
        day3_14: "Переезд в Hilton",
        day3_15: "Финальные питчи (Hilton)",
        day3_17: "Оценка жюри",
        day3_18: "Награждение и закрытие",
        
        // Prizes section
        prizes_title: "Призы и награды",
        prizes_subtitle: "Победители получат ценные призы от организаторов",
        first_place: "1 место",
        first_prize: "Ноутбуки",
        first_prize_desc: "Ноутбук для каждого члена команды",
        second_place: "2 место", 
        second_prize: "Планшеты",
        second_prize_desc: "Планшет для каждого члена команды",
        third_place: "3 место",
        third_prize: "Смартфоны",
        third_prize_desc: "Смартфон для каждого члена команды",
        special_prizes: "Спецпризы",
        special_prizes_amount: "Дипломы",
        special_prizes_desc: "Дипломы и призы от партнеров",
        
        // Mentors section
        mentors_title: "Менторы",
        mentors_subtitle: "Опытные профессионалы помогут вам воплотить идеи в жизнь",
        
        // Partners section
        partners_title: "Партнеры",
        partners_subtitle: "Благодарим наших партнеров за поддержку",
        
        // Registration section
        registration_title: "Регистрация",
        registration_subtitle: "Заполните форму для участия в хакатоне",
        form_name: "Имя и фамилия",
        form_email: "Email",
        form_phone: "Телефон",
        form_experience: "Опыт программирования",
        form_skills: "Навыки",
        form_team: "Команда",
        form_project: "Описание проекта",
        form_submit: "Отправить заявку",
        form_cancel: "Отмена",
        
        // Participants section
        participants_title: "Кто может участвовать",
        participants_subtitle: "Хакатон открыт для всех, кто готов создавать будущее с помощью AI",
        participants_students: "Студенты",
        participants_students_desc: "Студенты IT специальностей и смежных направлений",
        participants_developers: "Разработчики",
        participants_developers_desc: "Опытные программисты и начинающие разработчики",
        participants_designers: "Дизайнеры",
        participants_designers_desc: "UX/UI дизайнеры и специалисты по продуктовому дизайну",
        participants_entrepreneurs: "Предприниматели",
        participants_entrepreneurs_desc: "Бизнес-аналитики и стартап-основатели",
        
        // Criteria section
        criteria_title: "Критерии оценки",
        criteria_subtitle: "Проекты будут оцениваться по четырем основным критериям",
        
        // Detailed participants
        dev_title: "Разработчики",
        dev_frontend: "Frontend разработчики",
        dev_backend: "Backend разработчики",
        dev_mobile: "Mobile разработчики",
        dev_ai_ml: "AI/ML инженеры",
        dev_devops: "DevOps инженеры",
        design_title: "Дизайнеры",
        design_ux_ui: "UX/UI дизайнеры",
        design_product: "Продуктовые дизайнеры",
        design_graphic: "Графические дизайнеры",
        design_motion: "Motion дизайнеры",
        design_3d: "3D дизайнеры",
        business_title: "Бизнес",
        business_product_manager: "Продакт-менеджеры",
        business_analyst: "Бизнес-аналитики",
        business_marketer: "Маркетологи",
        business_entrepreneur: "Предприниматели",
        business_founder: "Стартап-основатели",
        
        // Evaluation criteria section
        evaluation_title: "Критерии оценки проектов",
        evaluation_subtitle: "Жюри будет оценивать проекты по следующим критериям",
        criteria_innovation: "Инновации",
        criteria_innovation_desc: "Оригинальность и новизна идеи",
        criteria_implementation: "Реализация",
        criteria_implementation_desc: "Техническое качество и завершенность",
        criteria_applicability: "Применимость",
        criteria_applicability_desc: "Практическая ценность решения",
        criteria_presentation: "Презентация",
        criteria_presentation_desc: "Качество подачи и демонстрации",
        ...
        mentors_title: "Менторы",
        mentors_subtitle: "Опытные профессионалы помогут вам воплотить идеи в жизнь",
        mentorship_title: "Менторская поддержка",
        mentorship_during: "Во время хакатона",
        mentorship_tech: "Консультации по техническим вопросам",
        mentorship_business: "Помощь в разработке бизнес-модели",
        mentorship_code: "Ревью кода и архитектуры",
        mentorship_presentation: "Подготовка презентации",
        ...
        // Timeline section
        timeline_title: "Дорожная карта",
        timeline_subtitle: "Ключевые этапы подготовки и проведения хакатона",
        timeline_registration: "Регистрация",
        timeline_registration_date: "15 июля - 1 августа 2025",
        timeline_registration_desc: "Подача заявок, отбор участников, формирование команд",
        timeline_preparation: "Подготовка",
        timeline_preparation_date: "Сейчас",
        timeline_preparation_desc: "Подготовка задач, привлечение менторов, организация площадки",
        timeline_hackathon: "Хакатон",
        timeline_hackathon_date: "6-8 августа 2025",
        timeline_hackathon_desc: "6-7 августа: School 21 (разработка) 8 августа: Hilton (финал и награждение)",
        timeline_results: "Результаты",
        timeline_results_date: "Август 2025",
        timeline_results_desc: "Награждение, менторство, развитие лучших проектов",
        
        // Footer section
        footer_title: "Готовы изменить мир?",
        footer_subtitle: "Присоединяйтесь к AI Хакатону Самарканд 2025 и создайте будущее вместе с нами",
        footer_organizer: "Организатор",
        footer_organizer_desc: "Angel Connect - Ведущая экосистема стартапов в Центральной Азии",
        footer_partners: "Партнеры",
        footer_partners_desc: "IT Park Uzbekistan - Министерство цифровых технологий Республики Узбекистан",
        footer_location: "Место проведения",
        footer_location_desc: "School 21 (6-7 августа) - Hilton Samarkand (8 августа) - Самарканд, Узбекистан",
        footer_copyright: "© 2025 AI Хакатон Самарканд. Все права защищены.",
        
        // Modal form
        modal_title: "Заявка на участие",
        modal_conditions: "Условия участия",
        modal_age: "Возраст: от 16 лет",
        modal_teams: "Команды: 3-5 человек",
        modal_limit: "Общий лимит: 100 участников",
        modal_selection: "Отбор заявок: 1-5 августа",
        form_name: "Имя и фамилия",
        ...
        form_specialization: "Специализация",
        form_specialization_placeholder: "Выберите специализацию",
        form_developer: "Разработчик",
        form_designer: "Дизайнер",
        form_business: "Бизнес-аналитик",
        form_manager: "Продакт-менеджер",
        form_other: "Другое",
        form_experience: "Опыт работы",
        form_experience_placeholder: "Выберите опыт",
        form_student: "Студент",
        form_junior: "Junior (до 2 лет)",
        form_middle: "Middle (2-5 лет)",
        form_senior: "Senior (5+ лет)",
        form_company: "Компания/Учебное заведение",
        form_company_placeholder: "Где вы работаете или учитесь",
        form_skills: "Технические навыки",
        form_skills_placeholder: "Опишите ваши технические навыки и технологии, которыми владеете",
        form_motivation: "Мотивация",
        form_motivation_placeholder: "Почему вы хотите участвовать в хакатоне?",
        form_has_project: "У меня есть идея для проекта",
        form_project_desc: "Описание проекта",
        form_project_placeholder: "Опишите вашу идею проекта",
        form_submit: "Отправить заявку",
        form_cancel: "Отмена",
        
        // Footer
        footer_text: "Организовано Angel Connect",
        footer_contact: "Контакты: @networkangelconnect",
        
        // About section
        about_title: "О ХАКАТОНЕ",
        about_text: "AI Хакатон Самарканд 2025 - это уникальная возможность для разработчиков, дизайнеров и предпринимателей создать инновационные решения с использованием искусственного интеллекта. Мероприятие пройдет в исторической столице Великого шелкового пути.",
        
        // Agenda section
        agenda_title: "ПРОГРАММА",
        day1_title: "ДЕНЬ 1 - СТАРТ",
        day1_desc: "Регистрация участников, формирование команд, презентация задач",
        day2_title: "ДЕНЬ 2 - РАЗРАБОТКА", 
        day2_desc: "Интенсивная работа над проектами, менторские сессии",
        day3_title: "ДЕНЬ 3 - ФИНАЛ",
        day3_desc: "Презентация проектов, оценка жюри, награждение",
        ...
        // Mentors section
        mentors_title: "МЕНТОРЫ",
        mentors_desc: "Опытные профессионалы из ведущих IT-компаний",
        ...
        // Registration section
        registration_title: "РЕГИСТРАЦИЯ",
        registration_desc: "Подайте заявку на участие в хакатоне",
        form_name: "Имя",
        form_email: "Email",
        form_phone: "Телефон",
        form_experience: "Опыт работы",
        form_team: "Команда (опционально)",
    ...
    uz: {
        ...
        footer_copyright: "© 2025 AI Xakaton Samarqand. Barcha huquqlar himoyalangan.",
    ...
    en: {
        ...
        footer_copyright: "© 2025 AI Hackathon Samarkand. All rights reserved.",
